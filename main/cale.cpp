...
static void http_post(void)
{
    ...
    esp_http_client_config_t config = {
        .url = "https://datacollectandtransformapi.azurewebsites.net/api/Battery/status", //CONFIG_CALE_SCREEN_URL,
    ...
    char *post_dataa = "{\"deviceId\":\"coco\",\"receiveDate\":\"pr\",\"data\":\"pi\",\"other\":\"vo\"}";
    esp_http_client_set_post_field(client, post_dataa, strlen(post_dataa)); 
